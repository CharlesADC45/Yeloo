...
import { Search, SlidersHorizontal, Plus, Home, MessageCircle, User, ArrowUp } from "lucide-react";
...
// translation hook is used inside the component

export function HomeScreen({ userType, userId, accessToken, onApartmentClick, onAddListing, onNavigate }: HomeScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <div className="p-6 border-b border-border">
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="h-14 w-14 bg-primary text-primary-foreground rounded-2xl flex items-center justify-center hover:bg-primary/90"
          >
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto p-6 space-y-4 pb-24 scroll-smooth">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 space-y-3">
            ...
            {userType === "landlord" && !searchQuery && (
              <p className="text-sm text-muted-foreground">Add your first listing to get started!</p>
            )}
          </div>
        ) : (
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-24 left-6 w-12 h-12 bg-card border-2 border-primary text-primary rounded-full shadow-lg flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors z-10"
        >
      ...
      {userType === "landlord" && (
        <button
          ...
          className="fixed bottom-24 right-6 w-16 h-16 bg-primary text-primary-foreground rounded-full shadow-lg flex items-center justify-center hover:bg-primary/90 z-10"
        >
